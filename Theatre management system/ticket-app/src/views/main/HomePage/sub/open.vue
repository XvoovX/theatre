        ...
        <div class="sales-board">
            ...
            <div class="sales-board-form">
                ...
                <div class="sales-board-line-right">
                    <!-- <Counter :postData.Quantity="counter"></Counter> -->
            ...
            <el-button @click="handleConfirmTicket">购票</el-button>
...
export default {
    ...
    methods: {
        ...
        handleConfirmTicket(ticketInfo) {
            ...
            console.log("确认购票", this.postData);
            // 获取当前时间
...
.sales-board-line {
    display: flex;
    justify-content: space-between;  /* 在每一行中，左右对齐 */
    width: 100%;
    margin-bottom: 10px;
}
